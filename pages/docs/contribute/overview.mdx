...
- **Application Process:** Get onboarded to the Pontus-X ecosystem by following the [onboarding guide](/docs/getting-started/onboarding-guide). Once onboarded you can launch any number of use cases and services without any further restrictions.
