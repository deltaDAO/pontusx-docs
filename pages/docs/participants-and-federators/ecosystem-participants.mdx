...
The list of Pontus-X participants keeps track of the onboarded and identified legal persons that are able to use the Pontus-X ecosystem. It summarizes the information collected in the Gaia-X participant credentials that have been issued over various versions of the [Gaia-X Trust Framework](https://gaia-x.gitlab.io/policy-rules-committee/trust-framework/) and onboarding workshops with Gaia-X Hubs across Europe.
