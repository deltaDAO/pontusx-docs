...
Before publishing assets, you need to fund your personal wallet with ROSE tokens.

Steps to Transfer Tokens
	1.	Log in to your assigned account.
	2.	Transfer ROSE tokens to your own controlled address.
	3.	Use your personal address for all publishing and transaction activities.

**Security Note**: Shared accounts are considered compromised. Always transfer funds to a personal account first before using it.

## 3. PTX Tokens – Usage & Acquisition

### What Are PTX Tokens?
- PTX tokens are used to log the price of assets in the ecosystem during the MVP.
- They serve as the primary medium of exchange for transactions for the Pontus-X MVP.
- Logging Tokens will be replaced by EURO integration as soon as available.
...
- Transaction failed: 	Ensure enough ROSE tokens are available for gas fees.
...
- [ ] Transfer ROSE tokens to your personal wallet.
