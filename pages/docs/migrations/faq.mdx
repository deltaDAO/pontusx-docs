...
Unlike testnet, transactions on the mainnet require gas fees in OASIS ROSE tokens. Ensure that your account has a sufficient balance before performing any operations. Publishing costs less than a cent under normal network conditions.
...
2. Setup Production Wallets and ensure you have enough OASIS ROSE tokens for deployment.
...
- Create a secure offline backup of private keys.

### Are shared keys safe to use for migration?
No. Always transfer assets to a private address that you control to maintain sovereignty over your service offerings, identity and associated funds.
