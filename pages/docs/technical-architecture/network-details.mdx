...
:::info
You can use the Pontus-X Devnet and Testnet without Metamask. See chapter [Wallet Setup](https://docs.pontus-x.eu/docs/getting-started/wallet-setup)
...
:::info
  **Note** that [EURAU](https://allunity.com/) is also used as a network fee token and is not identical with the ERC-20 EURAU token. The formerly used [EUROe](https://www.euroe.com/) token is deprecated.
:::
...
| ------------------------------------ | ------------------------------------------ | ------------- |
| [EURAU](https://allunity.com/)       | 0xE158265FD2be5BCc208621f2c0f8AfCF11aC8408 | Payment Token |
| [EUROe](https://www.euroe.com/)      | 0xdd0a0278f6BAF167999ccd8Aa6C11A9e2fA37F0a | Payment Token |
| [Ocean](https://oceanprotocol.com/)  | 0x5B190F9E2E721f8c811E4d584383E3d57b865C69 | Payment Token |

### Devnet

| Token Name                          | Smart Contract Address                     | Comment       |
| ----------------------------------- | ------------------------------------------ | ------------- |
| [EURAU](https://allunity.com/)      | 0x852381bB887d3Cf4AEB9e1E9De3eB033AF82fBeE | Payment Token |
| [EUROe](https://www.euroe.com/)     | 0x8A4826071983655805bF4f29828577Cd6b1aC0cB | Payment Token |
| [Ocean](https://oceanprotocol.com/) | 0xdF171F74a8d3f4e2A789A566Dce9Fa4945196112 | Payment Token |
...
:::info
  You also have the option to run your custom middleware components. These publicly available components are available for quick onboarding and less resource-intensive testing.
:::
